...
import { searchFoundItems } from "../../api/foundApi";
...
const FoundListPage = () => {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      try {
        ...
        if (filteredCategory !== "All Categories") params.category = filteredCategory;
        
        const result = await searchFoundItems(params);
    ...
    fetchItems();
  }, [debouncedSearchTerm, filteredCategory]);
  ...
  const sortedItems = useMemo(() => {
    return items.sort((a, b) => parseDate(b.dateFound) - parseDate(a.dateFound));
  }, [items]);
      ...
      <div style={styles.topBar}>
        ...
        <div style={styles.topBarRight}>
          ...
          <div style={styles.profileBox}>
            ...
            <div>
              <p style={styles.profileName}>Binusha</p>
